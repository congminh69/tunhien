...
Route::get('tunhien/login','DangKyController@loginLaravel')->name('logindashboard');
...
Route::get('tunhien/logo','DangKyController@getLogo')->name('logo');
Route::get('tunhien/address-phone-mail','DangKyController@getAPM')->name('apm');
Route::get('tunhien/footer','DangKyController@getfooter')->name('footer');
Route::get('tunhien/contact','DangKyController@getcontact')->name('contact');
Route::get('tunhien/google-map','DangKyController@getgooglemap')->name('googlemap');
Route::get('tunhien/logoslide','DangKyController@getlogoslide')->name('LogoSlide');
Route::get('tunhien/footer/{id}/edit','DangKyController@editFooter')->name('footer.edit');
Route::get('tunhien/about/{id}/edit','DangKyController@editAbout')->name('about.edit');
Route::get('tunhien/logoslide/{id}/edit','DangKyController@editLogoSlide')->name('logoslides.edit');
Route::get('tunhien/testimonials/{id}/edit','DangKyController@editTestimonial')->name('testimonials.edit');
Route::get('tunhien/statiscal/{id}/edit','DangKyController@editrowStatiscal')->name('statiscal.edit');
Route::get('tunhien/footer/delete','DangKyController@DeleteSocialFooter')->name('footer.delete');
Route::get('tunhien/about/delete','DangKyController@DeleteContentAbout')->name('about.delete');
Route::get('tunhien/logoslide/delete','DangKyController@DeleteLogoslides')->name('logoslides.delete');
Route::get('tunhien/testimonial/delete','DangKyController@DeleteTestiMonial')->name('testimonial.delete');
Route::get('tunhien/slidebar/delete','DangKyController@DeleteSLideBar')->name('slidebar.delete');
Route::get('tunhien/statistical/delete','DangKyController@DeleteRowstt')->name('statiscal.delete');
Route::get('tunhien/why/delete','DangKyController@Deleterowswhy')->name('why.delete');
Route::get('tunhien/menu/delete','DangKyController@Deletemenu')->name('menu.delete');
Route::get('tunhien/why/{id}/edit','DangKyController@editRowwhy')->name('why.edit');
Route::get('tunhien/menu/{id}/edit','DangKyController@editMenu')->name('menu.edit');
Route::get('tunhien/logo/{id}/edit','DangKyController@editLogo')->name('logo.edit');
Route::get('tunhien/product/delete','DangKyController@DeleteProduct')->name('product.delete');
Route::get('tunhien/menuheader','DangKyController@getmenuheader')->name('menuheader');
Route::get('tunhien/socialheader','DangKyController@getsocialheader')->name('socialheader');
Route::get('tunhien/dashboard','DangKyController@getContentsdashboard')->name('contentdashboard');
Route::get('tunhien/tesmonial','DangKyController@gettesmonial')->name('TesMonial');
Route::get('tunhien/statiscal','DangKyController@getstatiscal')->name('Statical');
Route::get('tunhien/why','DangKyController@getwhy')->name('Why');
Route::get('tunhien/about','DangKyController@getabout')->name('About');
Route::get('tunhien/product','DangKyController@getproduct')->name('Product');
Route::get('tunhien/slidebar','DangKyController@getslidebar')->name('Slidebar');
Route::get('tunhien/header','DangKyController@getheader')->name('Header');
Route::get('tunhien/product/{id}/edit','DangKyController@editProduct')->name('product.edit');
// end 
